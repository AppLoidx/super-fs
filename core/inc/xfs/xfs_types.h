...
enum XFS_DIR_FILETYPE {
  XFS_DIR_FILETYPE_UNKNOWN,
  XFS_DIR_FILETYPE_REG_FILE,
  XFS_DIR_FILETYPE_DIR,
  XFS_DIR_FILETYPE_CHRDEV,
  XFS_DIR_FILETYPE_BLKDEV,
  XFS_DIR_FILETYPE_FIFO,
  XFS_DIR_FILETYPE_SOCK,
  XFS_DIR_FILETYPE_SYMLINK,
  XFS_DIR_FILETYPE_WHT
};
...
typedef struct PACKED xfs_dir2_data_unused {
  __uint16_t freetag; // should be 0xffff (XFS_DIR2_DATA_UNUSED_FREETAG )
  xfs_dir2_data_off_t length;
  xfs_dir2_data_off_t tag;
...
/* 
 * From elixir.bootlin.com xfs/libxfs/xfs_bmap_btree.c
 */
